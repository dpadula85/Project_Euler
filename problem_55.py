# -*- coding: utf-8 -*-
"""
Created on Thu Mar 19 14:36:18 2015
...
start = time.time()
#the algorithm could be optimized storing the numbers < 10000 obtained during
#Lycherel test and skipping the test for them    
lycherel_nums = []
for n in range(1, 10000):
    if lycherel(n) and n not in lycherel_nums:
        lycherel_nums.append(n)
        
elapsed = (time.time() - start)
print len(lycherel_nums), 'in %5.3f seconds' % elapsed